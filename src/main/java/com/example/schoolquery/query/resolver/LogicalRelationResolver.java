...
public final class LogicalRelationResolver {
    ...
    public ResolvedRelationPlan resolve(long parentModuleId,long childModuleId){
        ...
        RelationPlan.RelationType type=r.type()==com.example.schoolquery.metadata.RelationType.ONE_TO_ONE?RelationPlan.RelationType.ONE_TO_ONE:RelationPlan.RelationType.ONE_TO_MANY;
