...
class QueryTreeBuilderTest {
    ...
    void resolvesInternalTableJoinsFromFieldOwningModuleContext() {
        ...
        Map<Long, java.util.List<com.example.schoolquery.metadata.SysModuleField>> requested =
        ...
        assertTrue(resolved.tableJoins().stream().allMatch(j ->
                j.ownerModuleId() == 103L && j.resolvedModulePath().equals(java.util.List.of(101L, 103L))));
